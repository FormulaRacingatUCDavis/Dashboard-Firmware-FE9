...
module top ;
	...
	wire [0:0] tmpOE__HV_Request_net;
	wire [0:0] tmpFB_0__HV_Request_net;
	wire [0:0] tmpIO_0__HV_Request_net;
	wire [0:0] tmpINTERRUPT_0__HV_Request_net;
	electrical [0:0] tmpSIOVREF__HV_Request_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8e4f2b05-bd25-4d02-b625-e8976f16d981"),
		  ...
		  .input_buffer_sel(2'b00))
		HV_Request
		 (.oe(tmpOE__HV_Request_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HV_Request_net[0:0]}),
		  .io({tmpIO_0__HV_Request_net[0:0]}),
		  .siovref(tmpSIOVREF__HV_Request_net),
		  .interrupt({tmpINTERRUPT_0__HV_Request_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HV_Request_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Drive_Request_net;
	wire [0:0] tmpFB_0__Drive_Request_net;
	wire [0:0] tmpIO_0__Drive_Request_net;
	wire [0:0] tmpINTERRUPT_0__Drive_Request_net;
	electrical [0:0] tmpSIOVREF__Drive_Request_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4828efa8-6f15-4921-9d02-173437c530ec"),
		  ...
		  .input_buffer_sel(2'b00))
		Drive_Request
		 (.oe(tmpOE__Drive_Request_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Drive_Request_net[0:0]}),
		  .io({tmpIO_0__Drive_Request_net[0:0]}),
		  .siovref(tmpSIOVREF__Drive_Request_net),
		  .interrupt({tmpINTERRUPT_0__Drive_Request_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Drive_Request_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TX_CAN0_net;
	wire [0:0] tmpFB_0__TX_CAN0_net;
	wire [0:0] tmpIO_0__TX_CAN0_net;
	wire [0:0] tmpINTERRUPT_0__TX_CAN0_net;
	electrical [0:0] tmpSIOVREF__TX_CAN0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		TX_CAN0
		 (.oe(tmpOE__TX_CAN0_net),
		  .y({Net_12}),
		  .fb({tmpFB_0__TX_CAN0_net[0:0]}),
		  .io({tmpIO_0__TX_CAN0_net[0:0]}),
		  .siovref(tmpSIOVREF__TX_CAN0_net),
		  .interrupt({tmpINTERRUPT_0__TX_CAN0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TX_CAN0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RX_CAN0_net;
	wire [0:0] tmpIO_0__RX_CAN0_net;
	wire [0:0] tmpINTERRUPT_0__RX_CAN0_net;
	electrical [0:0] tmpSIOVREF__RX_CAN0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		RX_CAN0
		 (.oe(tmpOE__RX_CAN0_net),
		  .y({1'b0}),
		  .fb({Net_11}),
		  .io({tmpIO_0__RX_CAN0_net[0:0]}),
		  .siovref(tmpSIOVREF__RX_CAN0_net),
		  .interrupt({tmpINTERRUPT_0__RX_CAN0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RX_CAN0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
